"""ORGCHART core — Org charts and headcount plans generated from CSV / HRIS export."""
...
RULES = [
    ("ORG-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("ORG-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("ORG-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
