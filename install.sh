#!/usr/bin/env sh
# Universal installer for orgchart. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/orgchart.git"
echo "Installing orgchart ..."
